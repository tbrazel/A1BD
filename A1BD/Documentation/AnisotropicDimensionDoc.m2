...
-- document{
--     Key => {(getAnisotropicDimensionQQ, GrothendieckWittClass), getAnisotropicDimensionQQ},
--     Headline => "Returns the anisotropic dimension of a symmetric bilinear form over the rationals",
--     Usage => "getAnisotropicDimensionQQ(beta)",
--     Inputs => {
...
-- 	},
--     PARA{"This is an implementation of [KC18, Algorithm 9] in Macaulay2. Using ", TO2(getAnisotropicDimensionQQp,"getAnisotropicDimensionQQp"), " and  ", TO2(signature,"signature"), " we can understand the anisotropic dimension of ", TEX///$\beta$///, " at all its relevant completions. The anisotropic dimension over ", TEX///$\mathbb{Q}$///, " is then computed as the maximum of the anisotropic dimensions over all completions."},
--     PARA{EM "Citations:"},
--     UL{
	
-- 	{"[KC18] P. Koprowski, A. Czogala, ", EM "Computing with quadratic forms over number fields,", " Journal of Symbolic Computation, 2018."},
--     },
--     SeeAlso => {"getAnisotropicDimensionQQp", "getAnisotropicDimension"}   
-- }
...
document{
    ...
    SeeAlso => {"getAnisotropicDimension", "getAnisotropicDimensionQQp"}   
}
